<div class="baseDatos view">
<h2><?php  echo __('Base Dato'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($baseDato['BaseDato']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($baseDato['BaseDato']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Base Dato'), array('action' => 'edit', $baseDato['BaseDato']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Base Dato'), array('action' => 'delete', $baseDato['BaseDato']['id']), null, __('Are you sure you want to delete # %s?', $baseDato['BaseDato']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Base Datos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Base Dato'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($baseDato['Empresa'] as $empresa): ?>
		<tr>
